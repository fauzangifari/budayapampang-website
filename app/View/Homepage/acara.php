...
<div class="page-wrapper">
    ...
    <section class="page-header" style="background-image: url(../assets/img/acarapage-background.png);">
        <div class="container">
            <h2>Acara</h2>
        </div><!-- /.container -->
    </section><!-- /.page-header -->
    ...
    <section class="venue-one">
        <div class="container">
            <div class="venue-one__top">
                ...
                <p>Wisata Budaya Pampang adalah perjalanan yang memukau melalui warisan budaya yang kaya dan beragam. Dari tradisi
                    seni rupa hingga pertunjukan musik, acara-acara budaya Pampang menawarkan pengalaman yang tak terlupakan bagi
                    pengunjung dari segala usia. Temukan pesona dan keindahan budaya kami melalui acara-acara yang penuh warna dan
                    beragam.</p>
            </div><!-- /.venue-one__top -->
            ...
            <div class="row high-gutter">
                <div class="col-lg-4">
                    <div class="venue-one__single">
                        <div class="venue-one__image">
                            <img src="../assets/img/home-acara1.png" alt="">
                        </div><!-- /.venue-one__image -->
                        <div class="venue-one__content">
                            <h3><a href="/acara/tari-khas-pampang">Tari Khas Pampang</a></h3>
                            <p><span class="venue-one__time">Setiap Sabtu & Minggu</span> <span class="venue-one__address">
                                    Menikmati tarian tradisional yang menggambarkan kekayaan budaya Kalimantan Timur.</span></p>
                            <a href="/acara/tari-khas-pampang" class="thm-btn venue-one__btn">Pelajari Lebih Lanjut</a><!-- /.thm-btn venue-one__btn -->
                ...
                <div class="col-lg-4">
                    <div class="venue-one__single">
                        <div class="venue-one__image">
                            <img src="../assets/img/home-acara2.png" alt="">
                        </div><!-- /.venue-one__image -->
                        <div class="venue-one__content">
                            <h3><a href="/acara/kerajinan-tangan">Kerajinan Tangan</a></h3>
                            <p><span class="venue-one__time">Setiap Hari</span> <span class="venue-one__address">
                                    Temukan keindahan kerajinan tangan asli dari Desa Pampang yang sarat makna budaya.</span></p>
                            <a href="/acara/kerajinan-tangan" class="thm-btn venue-one__btn">Pelajari Lebih Lanjut</a><!-- /.thm-btn venue-one__btn -->
                        </div><!-- /.venue-one__content -->
                    </div><!-- /.venue-one__single -->
                </div><!-- /.col-lg-4 -->
                <div class="col-lg-4">
                    <div class="venue-one__single">
                        <div class="venue-one__image">
                            <img src="../assets/img/home-acara3.png" alt="">
                        </div><!-- /.venue-one__image -->
                        <div class="venue-one__content">
                            <h3><a href="/acara/musik-tradisional">Musik Tradisional</a></h3>
                            <p><span class="venue-one__time">Setiap Jumat & Sabtu</span> <span class="venue-one__address">
                                    Nikmati alunan musik tradisional dari berbagai alat musik khas Kalimantan Timur.</span></p>
                            <a href="/acara/musik-tradisional" class="thm-btn venue-one__btn">Pelajari Lebih Lanjut</a><!-- /.thm-btn venue-one__btn -->
                        </div><!-- /.venue-one__content -->
                    </div><!-- /.venue-one__single -->
                </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
