...
<div class="page-wrapper">
        ...
        <div class="container">
            <div class="collection-grid__top">
                <div class="block-title-two text-center">
                    <p>Lokasi</p>
                    <h3>Lokasi <br> Budaya Pampang</h3>
                </div><!-- /.block-title-two -->
            </div><!-- /.collection-grid__top -->
            <div class="brand-one__content text-center">
                <div class="brand-one__map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.7317307315925!2d117.22751677496453!3d-0.377480699618811!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df5d9b0f0b2b7ad%3A0xf30e84b529acc826!2sWisata%20Budaya%20Pampang!5e0!3m2!1sid!2sid!4v1716291336081!5m2!1sid!2sid"
    ...
    <section class="cta-one" style="background-image: url(../assets/img/shapes/cta-bg-1-1.jpg);">
        <div class="container text-center">
            ...
            <p>
                Desa Budaya Pampang menawarkan pengalaman unik untuk menjelajahi kekayaan budaya Dayak Kenyah. Setiap
                minggunya, desa ini menyajikan berbagai pertunjukan tarian tradisional, upacara adat, dan pameran
                kerajinan tangan yang memukau.
            </p>
            <p>
                Tidak hanya sebagai destinasi wisata, Pampang juga berfungsi sebagai pusat edukasi di mana pengunjung
                dapat belajar langsung tentang sejarah dan tradisi suku Dayak Kenyah. Ini adalah kesempatan langka untuk
                menyaksikan dan berpartisipasi dalam kegiatan budaya yang autentik dan penuh warna.
            </p>
            <div class="cta-one__btn-block">
                <a href="/" class="thm-btn cta-one__btn-one">Pelajari Lebih Lanjut</a>
                <!-- /.thm-btn cta-one__btn-one -->
                <a href="/lokasi" class="thm-btn cta-one__btn-two">Rencanakan Kunjungan</a>
